    ...
    <section id="skills" className="w-full py-24 bg-background-forest/20">
      <div className="container mx-auto px-8 sm:px-12 lg:px-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-4 items-center">
          ...
          <div className="space-y-4 lg:pl-10 order-1 lg:order-2 text-center lg:text-left">
            <h2 className="text-[48px] sm:text-[64px] font-black text-text-accent leading-[48px] sm:leading-[54px] tracking-tight">
              Skills &<br />Tools
            </h2>
